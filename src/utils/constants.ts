...
function authorFactory(id: number, firstName: string, lastName: string,image: string, rating: number, text: string){
    return {
    id,
    firstName,
    lastName,
...
export const AuthorsArr = [
    authorFactory(123, 'Jean', 'Lao', JeanLao, 75, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do...'),
    authorFactory(124, 'Alfred', 'Smit', Alfred, 35, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do...'),
    authorFactory(125, 'Antonio', 'Edelman', Antoni, 97, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do...'),
    authorFactory(126, 'Daniel', 'Edwards', Daniel, 12, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do...'),
    authorFactory(127, 'Elizabeth', 'Rodjerson', Elizabet, 85, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do...'),
    authorFactory(128, 'Jessica', 'Alvaro', Jesica, 50, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do...'),
    authorFactory(129, 'Linda', 'Parker', Linda, 78, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do...'),
    authorFactory(130, 'Sandra', 'Alvaro', Sandra, 59, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do...'),
]
function productFactory(id: number, name: string, category: string, images: string[], price: number, notation: string, jevelParts: string[], authorID: number){
    return{
        id, name, category, images, price, notation, jevelParts, authorID,
    }
}
